                            ...
                            <Grid container>
                                ...
                                <Grid item xs={6} sm={6} md={6} xl={6} lg={6}>
                                    <div className="_3vIvU_bk">
                                        ...
                                        <div className="seller_bk"><span></span></div>
                                ...
                                <Grid item xs={4} sm={4} md={4} xl={4} lg={4}>
                                    <div className="_3aZm8l">
                                        <div className="bzD9az"><span className="_3ACFa6"><span className="_3o5jSD"></span></span><span class="_3ACFa6 _1wJt4G"></span></div>
                                    </div>
                                </Grid>
                            </Grid>
                        </Grid>
                        <Grid item xs={12} sm={12} md={12} xl={12} lg={12}>
                            <Grid container className="order_confirm_email">
                                <Grid item xs={12} sm={12} md={8} xl={8} lg={8}>
                                    {/* <div><h5>Order confirmation email will be sent to <b></b></h5></div> */}
                                </Grid>
                ...
                <Paper style={{ marginTop: '1.4rem' }}>
                    <div className="checkout-step checkout-step--active">
                                            ...
                                            <div className="panel panel-default credit-card-box">
                                                ...
                                                <div className="panel-body">
                                                    <form  id="payment-form">
                                                        ...
                                                        <div className="row">
                                                            <div className="col-xs-12">
                                                                <button className="btn btn-success btn-lg btn-block" type="submit"></button>
                                                            </div>
                                                        </div>
                        ...
                        <ExpansionPanel>
                            ...
                            <ExpansionPanelDetails className="card_details_parent">
                                <div className="clearfix"><div className="payment-confirm-tip" data-spm-anchor-id="a2a0e.payment_page.0.i6.28766af7uWKlE7"></div></div>
