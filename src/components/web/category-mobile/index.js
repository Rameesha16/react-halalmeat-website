...
//                             <div className="img-loader__wrapper"><img className="img-loader__img img-loader__img--shown " alt="CHICKEN" src="ch1.jpg" />
...
//                             <div className="category-name__name">CHICKEN</div>
//                             <div className="category-name__description" title="Pulses, Atta & Other Flours, Rice & Other Grains, Dry Fruits & Nuts, Edible Oils, Ghee & Vanaspati, Spices, Salt & Sugar, Organic Staples"></div>
//                         </div>
...
//                     <div className="store-categories-list__item" data-test-id="l0-category">
//                         <div className="category-image"><div className="img-loader__wrapper__wrapper">
//                             <div className="img-loader__wrapper"><img className="img-loader__img img-loader__img--shown " alt="" src="ki4.jpg" />
//                                 <span className="img-loader__placeholder img-loader__placeholder--circle img-loader__img img-loader__img--hidden img-loader__placeholder--category-card" />
//                             </div>
//                         </div>
//                         </div>
...
//                     <div className="store-categories-list__item" data-test-id="l0-category">
//                         <div className="category-image"><div className="img-loader__wrapper__wrapper">
//                             <div className="img-loader__wrapper"><img className="img-loader__img img-loader__img--shown " alt="" src="//cdn.grofers.com/app/images/category/cms_images/icon/icon_cat_163_v_3_500_ki5.jpg" />
//                                 <span className="img-loader__placeholder img-loader__placeholder--circle img-loader__img img-loader__img--hidden img-loader__placeholder--category-card" />
//                             </div>
//                         </div>
//                         </div>
