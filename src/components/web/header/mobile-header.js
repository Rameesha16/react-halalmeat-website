        ...
        return (
            <div>
                <Grid container className="header_info">
                    ...
                    <div className="logo">
                                        <h1><Link to="#"><img src="images/logohalal.png" alt="HALAL MEAt" style={{ width:"60px",height:"40px",marginLeft:"-200px" }} /> <h2 style={{ marginTop:"-33px", marginLeft:"30px", fontFamily:"Helvetica" }}>Halal Meat</h2> </Link></h1>                                  
                                          </div>
                        {/* <div className="logo-12" >
                            <img src="images/logohalal.png" alt="" />
                        </div> */}
                    </Grid>
